        ...
        <div className="flex items-center justify-between border-b border-gray-200 dark:border-white/10 p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-[13px] font-mono font-bold uppercase tracking-[0.2em] text-gray-900 dark:text-white mt-1">Cadastrar</h2>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-500 h-4 w-4" />
              <input
                type="text"
                value={name}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-500 h-4 w-4" />
                <input
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 p-1 text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:text-gray-300 transition-colors"
                >
          ...
          <div className="pt-3">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-purple-600 text-gray-900 dark:text-white font-bold tracking-[0.2em] text-[11px] uppercase py-4 px-4 transition-all hover:bg-purple-500 disabled:opacity-50 font-sans rounded-none"
            >
